...
<body>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="section-heading text-center">
                        <h2 style="color: yellowgreen;">SERVIS KAMI</h2>
                        <p>Kami menyediakan servis terbaik mengenai tanaman anggrek.</p>
                    </div>
                </div>
            </div>
    ...
    <section id="galeri" class="alazea-portfolio-area section-padding-100-0">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <!-- Section Heading -->
