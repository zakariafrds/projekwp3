...
<body>
    ...
    <script type="text/javascript" src="<?php echo base_url('assets/beranda') ?>/js/jquery-3.4.1.min.js"></script>
    <script type="text/javascript" src="<?php echo base_url('assets/beranda') ?>/js/bootstrap.js"></script>
